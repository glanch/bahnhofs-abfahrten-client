...
from ...models.journey_graph_request_options import JourneyGraphRequestOptions
...
def _get_kwargs(
    *,
    client: Client,
    json_body: JourneyGraphRequestOptions,
    profile: Union[Unset, None, AllowedHafasProfile] = UNSET,
) -> Dict[str, Any]:
    url = "{}/hafas/experimental/JourneyGraph".format(client.base_url)
