...
from ...models.journey_tree_request_options import JourneyTreeRequestOptions
...
def _get_kwargs(
    *,
    client: Client,
    json_body: JourneyTreeRequestOptions,
    profile: Union[Unset, None, AllowedHafasProfile] = UNSET,
) -> Dict[str, Any]:
    url = "{}/hafas/experimental/JourneyTree".format(client.base_url)
